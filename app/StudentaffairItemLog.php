...
class StudentaffairItemLog extends Model
{
    use SoftDeletes;
    protected $fillable = [Constants::DBC_DESCRIPTION, Constants::DBC_IS_FIXED, Constants::DBC_ITEM_ID, Constants::DBC_USER_ID];

    public function studentaffair_item()
    {
        return $this->belongsTo('App\StudentaffairItem',  Constants::DBC_ITEM_ID, Constants::DBC_REF_ID);
    }
