...
class CreateSportClearanceLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sport_clearance_logs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sport_clearance_logs');
    }
}
