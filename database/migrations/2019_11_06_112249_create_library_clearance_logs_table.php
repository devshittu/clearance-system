...
class CreateLibraryClearanceLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('library_clearance_logs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('library_clearance_logs');
    }
}
